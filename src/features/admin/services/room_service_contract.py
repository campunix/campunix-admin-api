...
class RoomServiceContract(ABC):
    ...
    @abstractmethod
    async def get_rooms(self, page: int = 1, page_size: int = 10, paginate: bool = False, search_query: Optional[str] = None) -> Dict[str, Any]:
        pass
    ...
    @abstractmethod
    async def get_room_types(self) -> Optional[Dict[str, Any]]:
        pass
