...
@pytest.mark.asyncio
async def test_create_department(department_service_mock, authorized_client, department_id_holder):
    department_req = {
...
@pytest.mark.asyncio
async def test_get_all_departments(department_service_mock, authorized_client):
...
@pytest.mark.asyncio
async def test_get_department_by_id(department_service_mock, authorized_client, department_id_holder):
...
@pytest.mark.asyncio
async def test_update_department(department_service_mock, authorized_client, department_id_holder):
    department_id = department_id_holder["id"]
    updated_data = {
...
@pytest.mark.asyncio
async def test_delete_department(department_service_mock, authorized_client, department_id_holder):
    department_id = department_id_holder["id"]
